import svgPaths from "./svg-73sf2v2u35";
  ...
  return (
    <div className="bg-white relative size-full" data-name="Enhance Frame Visual Appeal">
      <div className="absolute h-[811.429px] left-0 overflow-clip top-0 w-[1241.143px]" data-name="AnimatedBackground">
        ...
        <div className="absolute blur-3xl filter left-[80.7px] opacity-30 rounded-[1.9174e+07px] size-[388.646px] top-[43.73px]" data-name="Container" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\\'0 0 388.65 388.65\\\' xmlns=\\\'http://www.w3.org/2000/svg\\\' preserveAspectRatio=\\\'none\\\'><rect x=\\\'0\\\' y=\\\'0\\\' height=\\\'100%\\\' width=\\\'100%\\\' fill=\\\'url(%23grad)\\\' opacity=\\\'1\\\'/><defs><radialGradient id=\\\'grad\\\' gradientUnits=\\\'userSpaceOnUse\\\' cx=\\\'0\\\' cy=\\\'0\\\' r=\\\'10\\\' gradientTransform=\\\'matrix(0 -27.481 -27.481 0 194.32 194.32)\\\'><stop stop-color=\\\'rgba(240,147,251,1)\\\' offset=\\\'0\\\'/><stop stop-color=\\\'rgba(180,110,188,0.75)\\\' offset=\\\'0.175\\\'/><stop stop-color=\\\'rgba(120,74,126,0.5)\\\' offset=\\\'0.35\\\'/><stop stop-color=\\\'rgba(60,37,63,0.25)\\\' offset=\\\'0.525\\\'/><stop stop-color=\\\'rgba(0,0,0,0)\\\' offset=\\\'0.7\\\'/></radialGradient></defs></svg>')" }} />
        <div className="absolute blur-3xl filter left-[603.54px] opacity-30 rounded-[1.9174e+07px] size-[569.128px] top-[150.78px]" data-name="Container" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\\'0 0 569.13 569.13\\\' xmlns=\\\'http://www.w3.org/2000/svg\\\' preserveAspectRatio=\\\'none\\\'><rect x=\\\'0\\\' y=\\\'0\\\' height=\\\'100%\\\' width=\\\'100%\\\' fill=\\\'url(%23grad)\\\' opacity=\\\'1\\\'/><defs><radialGradient id=\\\'grad\\\' gradientUnits=\\\'userSpaceOnUse\\\' cx=\\\'0\\\' cy=\\\'0\\\' r=\\\'10\\\' gradientTransform=\\\'matrix(0 -40.243 -40.243 0 284.56 284.56)\\\'><stop stop-color=\\\'rgba(102,126,234,1)\\\' offset=\\\'0\\\'/><stop stop-color=\\\'rgba(77,95,176,0.75)\\\' offset=\\\'0.175\\\'/><stop stop-color=\\\'rgba(51,63,117,0.5)\\\' offset=\\\'0.35\\\'/><stop stop-color=\\\'rgba(26,32,59,0.25)\\\' offset=\\\'0.525\\\'/><stop stop-color=\\\'rgba(0,0,0,0)\\\' offset=\\\'0.7\\\'/></radialGradient></defs></svg>')" }} />
        <div className="absolute bg-white left-[85.93px] opacity-[0.685] rounded-[1.9174e+07px] size-[5.024px] top-[532.54px]" data-name="Container" />
        <div className="absolute bg-white left-[1026.64px] opacity-[0.417] rounded-[1.9174e+07px] size-[5.378px] top-[715.1px]" data-name="Container" />
        <div className="absolute bg-white left-[803.88px] opacity-[0.478] rounded-[1.9174e+07px] size-[6.117px] top-[424.85px]" data-name="Container" />
        <div className="absolute bg-white left-[1134.04px] opacity-[0.396] rounded-[1.9174e+07px] size-[5.12px] top-[514.21px]" data-name="Container" />
        <div className="absolute bg-white left-[771.15px] opacity-[0.387] rounded-[1.9174e+07px] size-[5.013px] top-[778.73px]" data-name="Container" />
        <div className="absolute bg-white left-[1130.34px] opacity-[0.051] rounded-[1.9174e+07px] size-[0.736px] top-[807.98px]" data-name="Container" />
        <div className="absolute bg-white left-[745.85px] opacity-[0.057] rounded-[1.9174e+07px] size-[0.82px] top-[268.31px]" data-name="Container" />
        <div className="absolute bg-white left-[152.58px] opacity-[0.185] rounded-[1.9174e+07px] size-[1.446px] top-[685.05px]" data-name="Container" />
        <div className="absolute bg-white left-[339.69px] opacity-[0.448] rounded-[1.9174e+07px] size-[5.753px] top-[716.53px]" data-name="Container" />
        <div className="absolute bg-white left-[1136.82px] opacity-[0.45] rounded-[1.9174e+07px] size-[3.413px] top-[159.49px]" data-name="Container" />
        <div className="absolute bg-white left-[1067.96px] opacity-[0.675] rounded-[1.9174e+07px] size-[7.977px] top-[336.45px]" data-name="Container" />
        <div className="absolute bg-white h-[5.45px] left-[1076.23px] opacity-[0.751] rounded-[1.9174e+07px] top-[102.24px] w-[5.449px]" data-name="Container" />
        <div className="absolute bg-white left-[1204.75px] opacity-[0.155] rounded-[1.9174e+07px] size-[2.11px] top-[258.51px]" data-name="Container" />
        <div className="absolute bg-white left-[828.92px] opacity-[0.019] rounded-[1.9174e+07px] size-[0.281px] top-[644.43px]" data-name="Container" />
        <div className="absolute bg-white left-[452.13px] opacity-[0.62] rounded-[1.9174e+07px] size-[4.593px] top-[153.73px]" data-name="Container" />
        <div className="absolute bg-white left-[780.92px] opacity-[0.084] rounded-[1.9174e+07px] size-[1.178px] top-[550.78px]" data-name="Container" />
        <div className="absolute bg-white left-[533.58px] opacity-[0.676] rounded-[1.9174e+07px] size-[7.975px] top-[121.07px]" data-name="Container" />
        <div className="absolute bg-white left-[726.18px] opacity-[0.097] rounded-[1.9174e+07px] size-[1.355px] top-[194.67px]" data-name="Container" />
        <div className="absolute bg-white left-[390.21px] opacity-[0.243] rounded-[1.9174e+07px] size-[3.234px] top-[290.13px]" data-name="Container" />
        <div className="absolute bg-white left-[277.6px] opacity-[0.339] rounded-[1.9174e+07px] size-[2.606px] top-[659.98px]" data-name="Container" />
      </div>
      <div className="absolute h-[4029.714px] left-0 overflow-clip top-0 w-[1241.143px]" data-name="App">
        ...
        <div className="absolute h-[24px] left-[573.22px] top-[3919.81px] w-[94.696px]" data-name="Container">
        ...
        <div className="absolute h-[811.429px] left-0 top-0 w-[1241.143px]" data-name="Container">
          ...
          <div className="absolute h-[500px] left-[420.57px] top-[35.71px] w-[400px]" data-name="Container">
            <div className="absolute bg-[rgba(255,255,255,0)] border-4 border-[rgba(255,255,255,0.3)] border-solid h-[500px] left-0 overflow-clip rounded-[24px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] top-0 w-[400px]" data-name="Container">
              ...
              <BackgroundImage6 additionalClassNames="left-[352.46px] size-[82.887px] top-[-81.47px]">
                <div className="flex-none rotate-[293.31deg]">
                  <div className="content-stretch flex flex-col items-start relative size-[63.076px]" data-name="Container">
                    <div className="h-[63.076px] overflow-clip relative shadow-[0px_4px_8px_0px_rgba(0,0,0,0.15)] shrink-0 w-full" data-name="Icon">
                      <div className="absolute inset-[8.32%]" data-name="Vector">
                        <div className="absolute inset-[-5%]">
                          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 57.8322 57.8322">
                            <path d={svgPaths.p3ab6cd00} id="Vector" stroke="var(--stroke-0, #FFDF20)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="5.25632" />
                          </svg>
                        </div>
                      </div>
                      <div className="absolute bottom-3/4 left-[83.33%] right-[16.67%] top-[8.33%]" data-name="Vector">
                        <div className="absolute inset-[-25%_-2.63px]">
                          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.25632 15.769">
                            <path d="M2.62816 2.62816V13.1408" id="Vector" stroke="var(--stroke-0, #FFDF20)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="5.25632" />
                          </svg>
                        </div>
                      </div>
                      <div className="absolute bottom-[83.33%] left-3/4 right-[8.33%] top-[16.67%]" data-name="Vector">
                        <div className="absolute inset-[-2.63px_-25%]">
                          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.769 5.25632">
                            <path d="M13.1408 2.62816H2.62816" id="Vector" stroke="var(--stroke-0, #FFDF20)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="5.25632" />
                          </svg>
                        </div>
                      </div>
                      <div className="absolute bottom-[8.33%] left-[8.33%] right-3/4 top-3/4" data-name="Vector">
                        <div className="absolute inset-[-25%]">
                          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.769 15.769">
                            <path d={svgPaths.p27476900} id="Vector" stroke="var(--stroke-0, #FFDF20)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="5.25632" />
                          </svg>
                        </div>
                      </div>
                    </div>
              ...
              <BackgroundImage6 additionalClassNames="left-[-23.45px] size-[75.37px] top-[432.2px]">
                <div className="flex-none rotate-[328.92deg]">
                  <div className="content-stretch flex flex-col items-start relative size-[54.907px]" data-name="Container">
                    <IconBackgroundImage2 additionalClassNames="h-[54.907px] shadow-[0px_4px_8px_0px_rgba(0,0,0,0.15)]">
                      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 50.3358 48.2088">
                        <path d={svgPaths.p1ef33600} id="Vector" stroke="var(--stroke-0, #FDA5D5)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4.57561" />
                      </svg>
                    </IconBackgroundImage2>
                  </div>
                </div>
            ...
            <BackgroundImage6 additionalClassNames="left-[292.27px] size-[154.17px] top-[-52.83px]">
              <div className="flex-none rotate-[18.648deg]">
                <div className="opacity-50 relative size-[121.656px]" data-name="App">
                  <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-contain pointer-events-none size-full" src={imgApp1} />
                </div>
              </div>
            </BackgroundImage6>
          </div>
          <div className="absolute content-stretch flex h-[40px] items-start justify-center left-[608.57px] pb-[1.714px] pt-[14.973px] px-[1.714px] rounded-[1.9174e+07px] top-[735.81px] w-[24px]" data-name="Container">
