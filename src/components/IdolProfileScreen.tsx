  ...
  'virtual-male': {
    ...
    background: {
      ...
      description: [
        ...
        '"트렌디 아이콘"',
        '평소엔 차분하지만, 무대 위에서는 완전히 다른 사람. 팬들은 이 간극을 "리안의 진짜 매력"이라 부른다.',
      ],
      quote:
        '감성 음악을 넘어 스토리 기반 퍼포먼스, 새로운 사운드 실험까지 — 미래가 가장 궁금한 아이돌',
    },
    personality: {
    ...
    hobbies: {
      description: '취미 또한 "내향적 안정 + 아이돌다운 활동성"이 적절히 섞여 있다.',
      items: [
  ...
  'virtual-female': {
    ...
    background: {
      ...
      description: [
        '우아하면서도 강렬한 무대 매너로',
        '"천상의 아이돌"',
        '평소엔 부드럽지만, 무대 위에서는 압도적인 카리스마. 팬들은 이 변화를 "아리아의 진정한 힘"이라 말한다.',
      ],
      quote:
        '전통과 현대를 넘나드는 음악 세계 — 새로운 시도를 두려워하지 않는 아티스트',
    },
    personality: {
    ...
    interests: {
      description: '아리아는 음악과 퍼포먼스 외에도 다양한 예술 장르에 관심이 많다.',
      items: [
        {
          title: '팬 커뮤니케이션',
    ...
    musicGenre: {
      title: '모던 팝 / 얼터너티브 R&B',
      descriptions: [
        '아리아의 음악은 모던 팝과 얼터너티브 R&B를 기반으로 한다.',
        '파워풀하면서도 섬세한 보컬로 감정의 스펙트럼을 표현한다.',
        '실험적인 사운드와 전통적인 요소를 조화롭게 융합하는 능력이 뛰어나며,',
        '디테일에 대한 집착으로 완성도 높은 음악을 추구하는 프로페셔널.',
      ],
    },
    hobbies: {
      description: '취미 또한 "예술적 감수성 + 실용적 활동"이 균형있게 섞여 있다.',
      items: [
  ...
  'human-male': {
    ...
    background: {
      ...
      description: [
        ...
        '"무대의 태양"',
        '평소에도 활발하지만, 무대 위에서는 더욱 폭발적인 에너지. 팬들은 이 열정을 "준호의 빛"이라 부른다.',
      ],
      quote:
        '노력으로 만들어가는 무대 — 멈추지 않는 성장과 도전의 아이콘',
    },
    personality: {
    ...
    interests: {
      description: '준호는 퍼포먼스 외에도 다양한 신체 활동과 창작에 관심이 많다.',
      items: [
        {
          title: '팬 미팅',
    ...
    musicGenre: {
      title: '에너지틱 팝 / 댄스 일렉트로닉',
      descriptions: [
        '준호의 음악은 에너제틱 팝과 댄스 일렉트로닉을 기반으로 한다.',
        '파워풀한 비트와 중독성 있는 멜로디로 청중을 사로잡는다.',
        '무대 위에서 최대한의 에너지를 발산할 수 있는 곡을 선호하며,',
        '완벽한 퍼포먼스를 위해 끊임없이 연습하는 노력파 아이돌.',
      ],
    },
    hobbies: {
      description: '취미 또한 "활동인 에너지 + 창의적 표현"이 조화롭게 섞여 있다.',
      items: [
        { text: '새벽 러닝과 체력 단련하기', color: '#fb64b6' },
        { text: '안무 영상 보며 새로운 동작 연구하기', color: '#c27aff' },
        { text: '연습실에서 프리스타일 댄스 즐기기', color: '#51a2ff' },
        { text: '팬들의 응원 메시지 읽으며 동기부여 받기', color: '#00d3f3' },
      ],
  ...
  'human-female': {
    ...
    background: {
      ...
      description: [
        '맑고 청아한 목소리와 우아한 매너로',
        '"하늘이 내린 목소리"',
        '평소엔 친근하지만, 무대 위에서는 프로페셔널한 카리스마. 팬들은 이 조화를 "서연의 완벽함"이라 칭한다.',
      ],
      quote:
        '진심을 담은 음악 — 노래로 사람들의 마음을 위로하는 아티스트',
    },
    personality: {
    ...
    interests: {
      description: '서연은 음악 외에도 사람들과의 소통과 다양한 문화에 관심이 많다.',
      items: [
        {
          title: '팬과의 교감',
    ...
    musicGenre: {
      title: '감성 발라드 / 어쿠스틱 팝',
      descriptions: [
        '서연의 음악은 감성 발라드와 어쿠스틱 팝을 기반으로 한다.',
        '맑고 청아한 보컬로 청자의 마음을 울리는 감동을 전달한다.',
        '진솔한 가사와 섬세한 표현으로 공감대를 형성하는 능력이 뛰어나며,',
        '노래에 진심을 담아 사람들에게 위로를 전하는 진정한 아티스트.',
      ],
    },
    hobbies: {
      description: '취미 또��� "감성적 여유 + 진실된 소통"이 자연스럽게 어우러져 있다.',
      items: [
...
export function IdolProfileScreen({ idolType, idolGender, onNext, onBack }: IdolProfileScreenProps) {
  ...
  return (
    <div className="min-h-screen overflow-auto">
      ...
      {/* Hero Section */}
      <div className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 py-12 sm:py-0">
        {/* Back Button */}
        <button
          onClick={onBack}
          className="absolute top-4 sm:top-6 left-4 sm:left-6 flex items-center space-x-2 text-purple-200 hover:text-white transition-colors z-10"
        >
        ...
        <div className="relative mb-4 sm:mb-6">
          <div className="w-[220px] h-[280px] sm:w-[280px] sm:h-[350px] lg:w-[320px] lg:h-[400px] border-4 border-white/30 rounded-3xl overflow-hidden shadow-2xl transition-all duration-500 hover:scale-105 hover:shadow-purple-500/50 hover:border-white/50 group">
            <img
              src={profile.image}
              alt={profile.name}
        ...
        <div className="text-center space-y-2 sm:space-y-3">
          <h1 
            className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-white via-pink-200 to-purple-200 bg-clip-text text-transparent"
          >
            {profile.typeLabel} · {profile.name}
          </h1>
          <div className="space-y-1">
            <p className="text-3xl sm:text-4xl lg:text-5xl text-white/90 font-normal">About</p>
            <p className="text-3xl sm:text-4xl lg:text-5xl text-white/90 italic font-normal">{profile.name}</p>
          </div>
        </div>

        {/* Scroll Indicator */}
        <div className="absolute bottom-4 sm:bottom-8 flex flex-col items-center">
      ...
      <div className="relative bg-transparent px-4 sm:px-6 lg:px-8 pb-10 sm:pb-16">
        <div className="max-w-5xl mx-auto space-y-6 sm:space-y-8">
          {/* Basic Info Card */}
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/20 shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-purple-500/30 hover:border-white/30">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
              <div className="text-center space-y-1.5 group cursor-pointer">
                <p className="text-pink-300 text-xs uppercase tracking-wider transition-all group-hover:text-pink-200 group-hover:scale-110">Real Name</p>
                <p className="text-white text-lg sm:text-xl transition-all group-hover:scale-105">{profile.realName}</p>
              </div>
              <div className="text-center space-y-1.5 group cursor-pointer">
                <p className="text-purple-300 text-xs uppercase tracking-wider transition-all group-hover:text-purple-200 group-hover:scale-110">Agency</p>
                <p className="text-white text-lg sm:text-xl transition-all group-hover:scale-105">{profile.agency}</p>
              </div>
              <div className="text-center space-y-1.5 group cursor-pointer">
                <p className="text-blue-300 text-xs uppercase tracking-wider transition-all group-hover:text-blue-200 group-hover:scale-110">Group</p>
                <p className="text-white text-lg sm:text-xl transition-all group-hover:scale-105">{profile.group}</p>
              </div>
            </div>
          </div>
          ...
          {/* Stats Card */}
          <div 
            className="rounded-2xl p-5 sm:p-7 border border-white/30 shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-purple-500/30 hover:border-white/40"
            style={{
          ...
          >
            <div className="flex items-center justify-center gap-2 mb-5 sm:mb-7">
              ...
              <h2 
                className="text-xl sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-white via-pink-200 to-purple-200 bg-clip-text text-transparent"
              >
                아이돌 스탯
              </h2>
              <svg className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {statItems.map((stat, index) => (
                <div key={index} className="space-y-1.5 group">
                  <div className="flex justify-between items-center">
                    <span className="text-white/90 text-sm transition-all group-hover:text-white group-hover:scale-105">{stat.name}</span>
                    <span className="text-white/70 text-xs transition-all group-hover:text-white/90">{stat.value}/100</span>
                  </div>
                  <div className="h-2.5 bg-white/10 rounded-full overflow-hidden group-hover:h-3 transition-all">
                    <div
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 mt-5 sm:mt-6">
              {profile.traits.map((trait, index) => (
                <div
                  key={index}
                  className="px-3 py-1.5 sm:px-3 sm:py-2 rounded-full border cursor-pointer transition-all hover:scale-110 hover:shadow-lg text-xs sm:text-sm"
                  style={{
          ...
          {/* Background Section */}
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 sm:p-7 border border-white/20 shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-purple-500/30 hover:border-white/30">
            <div className="flex items-center gap-2.5 sm:gap-3 mb-4 sm:mb-6">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-pink-500 to-purple-500 rounded-xl flex items-center justify-center flex-shrink-0">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
              </div>
              <h3 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-white via-pink-200 to-purple-200 bg-clip-text text-transparent">
                배경
              </h3>
            </div>
            
            <div className="space-y-2.5 sm:space-y-3 text-gray-200">
              ...
              <p className="text-sm sm:text-base">{profile.background.description[2]}</p>
              <div className="bg-white/5 border border-white/10 rounded-xl p-3 sm:p-4 mt-3 sm:mt-4">
                <p className="text-pink-200 italic text-xs sm:text-sm">{profile.background.quote}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 sm:p-7 border border-white/20 shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-purple-500/30 hover:border-white/30">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-3 sm:mb-4">
              <div 
                className="p-4 sm:p-5 rounded-xl border border-white/10"
                style={{ background: 'linear-gradient(168.421deg, rgba(246, 51, 154, 0.2) 0%, rgba(173, 70, 255, 0.2) 100%)' }}
              >
                <p className="text-pink-300 font-bold text-sm sm:text-base mb-1.5">일상에서</p>
                <p className="text-gray-200 text-xs sm:text-sm">{profile.personality.daily}</p>
              </div>
              <div 
                className="p-4 sm:p-5 rounded-xl border border-white/10"
                style={{ background: 'linear-gradient(168.421deg, rgba(173, 70, 255, 0.2) 0%, rgba(43, 127, 255, 0.2) 100%)' }}
              >
                <p className="text-purple-300 font-bold text-sm sm:text-base mb-1.5">무대에서</p>
                <p className="text-gray-200 text-xs sm:text-sm">{profile.personality.onStage}</p>
              </div>
            </div>
            <p className="text-center text-pink-200 font-bold text-xs sm:text-sm">{profile.personality.summary}</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 sm:p-7 border border-white/20 shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-purple-500/30 hover:border-white/30">
            ...
            <p className="text-sm sm:text-base text-center mb-3 sm:mb-4">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-3 sm:p-4 space-y-2">
              {profile.essence.details.map((detail, index) => (
                <p key={index} className="text-gray-200 text-sm sm:text-base">{detail}</p>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 sm:p-7 border border-white/20 shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-purple-500/30 hover:border-white/30">
            ...
            <p className="text-gray-200 mb-3 sm:mb-4 text-xs sm:text-sm">{profile.interests.description}</p>
          ...
          {/* Music Genre Section */}
          <div 
            className="rounded-2xl p-5 sm:p-7 border border-white/20 shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-purple-500/30 hover:border-white/30"
            style={{
          ...
          >
            ...
            <h4 
              className="text-lg sm:text-xl font-bold text-center mb-3 sm:mb-4 bg-gradient-to-r from-pink-300 via-purple-300 to-blue-300 bg-clip-text text-transparent"
            >
              {profile.musicGenre.title}
            </h4>
            <div className="space-y-1.5 sm:space-y-2">
              {profile.musicGenre.descriptions.map((desc, index) => (
                <p key={index} className={`text-gray-200 text-xs sm:text-sm ${index === profile.musicGenre.descriptions.length - 1 ? 'text-purple-300' : ''}`}>
                  {desc}
                </p>
              ))}
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 sm:p-7 border border-white/20 shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-purple-500/30 hover:border-white/30">
            ...
            <p className="text-gray-200 mb-3 sm:mb-4 text-xs sm:text-sm">{profile.hobbies.description}</p>
            <div className="space-y-2 mb-3 sm:mb-4">
              {profile.hobbies.items.map((hobby, index) => (
                <div key={index} className="bg-white/5 border border-white/10 rounded-xl p-2.5 sm:p-3 flex items-center gap-2.5 sm:gap-3">
                  <div className="w-1.5 h-1.5 rounded-full flex-shrink-0" style={{ backgroundColor: hobby.color }} />
                  <p className="text-gray-200 text-xs sm:text-sm">{hobby.text}</p>
                </div>
              ))}
            </div>
            <p className="text-center text-blue-200 italic text-xs sm:text-sm">{profile.hobbies.summary}</p>
          </div>
